function [itdir, itpo,symmetrylineencounter]=eikonal2D(domain,pooo1,pooo2,dir1,dir2,maxsteps,maxangles, absorptioncutoff,symmetryline,ss)
    ...
    for a=1:maxangles
        ...
        options = odeset(options,'InitialStep',ss);
        ...
        while flag_out
            if n_reflections< max_reflections
                ...
                if flag_boundary==1 && n_end>cut_off_limit
                    ...
                    if k1==1
                        [ktemp] = dsearchn([mesh(k1+1,:); mesh(k1,:)],[y(end,1) y(end,2)]);
                    else
