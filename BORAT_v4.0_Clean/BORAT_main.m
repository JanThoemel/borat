...
%pause('on');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
NAME='BlackOut RAy-Tracer for Magnetized Plasma';NAMESHORT='BORAT ';VERSION=4.0;
...
%%%% Select Magnetic Field Option %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    
    MagneticField=0;        %%: (0: no B-Field, 1: MHD CFD Solution, 2: Arbitrary B-Field)
   ...
   % Coordinate System %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Cartesian = 1; %%: 1 = Cartesian, 0 = Cylindrical
...
if read == 1
    ...
    domain=readflowfield_tecplot(flowfieldfilename,f,Cartesian,B1,B2,B3,MagneticField, collisionmodel,shrinkfactor,indexofelectronspecies,Species,pltformat,mixture_name,state_model_str,nb_species,indexof1stspecies,nb_temperatures,indexof1sttemperature,compositiontype,indexoftotaldensity);

elseif import ==1
    
    domain=import_flowfield_tecplot(flowfieldfilename,f,Cartesian,B1,B2,B3,MagneticField, collisionmodel,shrinkfactor,indexofelectronspecies,Species,pltformat,mixture_name,state_model_str,nb_species,indexof1stspecies,nb_temperatures,indexof1sttemperature,compositiontype,indexoftotaldensity);
...
if solverSnell==1
    if MagneticField==0
        [itdir, itpo,symmetrylineencounter]=raytracing(domain,pooo1,pooo2,dir1,dir2,maxsteps,maxangles, absorptionlimits(2)-10,symmetryline,ss,f,Cartesian,B1,B2,B3,MagneticField);
    elseif MagneticField==1
        [itdir, itpo,symmetrylineencounter,Y_int_1,Y_int_2,Y_int_3,YY]=raytracing_Magnetic(domain,pooo1,pooo2,dir1,dir2,maxsteps,maxangles, absorptionlimits(2)-10,symmetryline,ss,f,Cartesian,B1,B2,B3,MagneticField);
    end
...
elseif solverEikonal==1
    ...
    elseif MagneticField==1
        error('No magnetic rytracing possible with Eikonal solver')
    %[itdir, itpo,symmetrylineencounter]=eikonal2D_Magnetic(domain,pooo1,pooo2,dir1,dir2,maxsteps,maxangles, absorptionlimits(2)-10,symmetryline,ss,f,Cartesian,B1,B2,B3,MagneticField);
    end
