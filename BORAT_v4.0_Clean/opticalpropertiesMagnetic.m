function [X,Z,ri,ac]=opticalpropertiesMagnetic(f,collisionmodel,Cartesian,B1,B2,B3,MagneticField,variables,Nova)
    ...
    switch collisionmodel
        case 0 %% no collisions
                ...
                electronnumberdensity=variables(Nova+1);
        ...
        case 1 %% mutation collisions
            %% compute electrondensity
            electronnumberdensity= variablesvariables(Nova+1);
            %% compute collisionfrequency
            collisionfrequency=variablesvariables(Nova+2);
            %% compute X
            X=kk*electronnumberdensity/f^2;
            %% compute Z
