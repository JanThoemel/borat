function domain=readflowfield_tecplot(flowfieldfilename,f,collisionmodel, shrinkfactor,indexofelectronspecies,Species,pltformat,mixture_name,state_model_str,nb_species,indexof1stspecies,nb_temperatures,indexof1sttemperature,compositiontype,indexoftotaldensity)
    ...
    while ~feof(id)
      ...
      elseif pltformat==9 % VKI
        ...
        for i=1:domain.( strcat('zone',num2str(z)) ).N
            ...
            [domain.(strcat('zone',num2str(z))).variables(domain.nova+3,i),domain.(strcat('zone',num2str(z))).variables(domain.nova+4,i),domain.(strcat('zone',num2str(z))).variables(domain.nova+5,i),domain.(strcat('zone',num2str(z))).variables(domain.nova+6,i)]  =  opticalproperties(f,collisionmodel, domain.(strcat('zone',num2str(z))).variables(:,i),Nova );
        end
